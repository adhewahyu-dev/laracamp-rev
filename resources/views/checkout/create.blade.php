                        ...
                        <div class="col-lg-6 col-12">
                            <form action="{{route('checkout.store', $camp->id)}}" class="basic-form" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="email" name="email" type="email" class="form-control {{$errors->has('email') ? 'is-invalid' : ''}}" value="{{Auth::user()->email}}" />
                                    @if ($errors->has('email'))
                                ...
                                <p class="text-center subheader mt-4">
                                    <img src="{{asset('images/ic_secure.svg')}}"> Your payment is secure and encrypted.
                                </p>
                            </form>
                        </div>
                    </div>
